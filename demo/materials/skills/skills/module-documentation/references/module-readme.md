...
[Название] — базовый модуль для [назначение].

## Назначение

[Детальное описание что предоставляет модуль]
...
Предоставляет интерфейсы компонентов для экранов авторизации
и связанные domain модели.
