...
fun RegistrationScreen(
    ...
    Column(
        ...
        RegistrationTextField(
            ...
            placeholder = stringResource(R.string.registration_hint_first_name),
            isError = uiState.firstNameError,
            errorText = stringResource(R.string.registration_error_first_name),
        ...
        RegistrationTextField(
            ...
            placeholder = stringResource(R.string.registration_hint_last_name),
            isError = uiState.lastNameError,
            errorText = stringResource(R.string.registration_error_last_name),
        ...
        RegistrationTextField(
            value = uiState.login,
            placeholder = stringResource(R.string.registration_hint_login),
            isError = uiState.loginError,
            errorText = stringResource(R.string.registration_error_login),
        ...
        RegistrationTextField(
            ...
            placeholder = stringResource(R.string.registration_hint_password),
            isError = uiState.passwordError,
            errorText = stringResource(R.string.registration_error_password),
