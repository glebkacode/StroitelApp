...
fun PhoneValidationScreen(
    ...
    Column(
        ...
        TextField(
            ...
            placeholder = {
                Text(
                    text = stringResource(R.string.phone_validation_hint_text),
        ...
        Button(
            ...
            Text(
                text = stringResource(R.string.auth_login_text),
        ...
        Text(
            text = stringResource(R.string.phone_validation_sign_up),
            color = StroitelTheme.colorScheme.text.moscow,
            fontWeight = FontWeight.Normal,
            fontSize = 15.sp,
            modifier = Modifier
